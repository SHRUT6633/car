"""
======================================================================================
               STANDALONE SENSOR VERIFICATION RUNNER
      Exact Hardware Setup for VL53L1X, VL53L0X (Left/Right), and MPU6050
======================================================================================
"""
import time
import sys
...
try:
    ...
    print("Please install requirements: pip install adafruit-circuitpython-vl53l0x adafruit-circuitpython-vl53l1x mpu6050-raspberrypi")
    sys.exit(1)
...
def test_hardware_loop():
    ...
    print("Starting sensor streaming loop... Press Ctrl+C to terminate.")
    try:
        while True:
        ...
        print("\n[INFO] Sensor test terminated by user.")
